...
> **Governance decision (2026-05-19 - #DZ-5376)** Rosa: severity-scoped rotation probe rounding. The severity-scoped half of the rotation probe is ROUNDED UP: `volatility_index = stability_pressure_score + (all_rotation_probe_ms // 24) + ceil(severity_rotation_probe_ms / 16) + rotation_segment_count * 2`. The all-scoped half keeps its floor and the segment term is unchanged, so the two halves of this score round in opposite directions.
